			...
			<div class="row">
					...
					<div class="left-sidebar">
						...
						<div class="price-range"><!--price-range-->
							...
							<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="priceController.jsp">
										<input type = "hidden" name = "katigoria" value = "Smartphones-Κινητά-Αξεσουάρ Κινητών" />
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<h2 class="title text-center">Smartphones-Κινητα-Αξεσουαρ Κινητων</h2>
			<% int counter = 0; 
				String descr;
				String categ;
			 ...
			 for(GetProduct product : myProducts){ 
			  ...
			  if(categ.equals("Smartphones-Κινητά-Αξεσουάρ Κινητών")){
